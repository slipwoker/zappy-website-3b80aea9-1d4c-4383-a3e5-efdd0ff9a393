...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (field.hasAttribute('required') || field.classList.contains('input-error')) {
                clearError(field);
            }
        });
    }
    ...
    if (fadeElements.length > 0) {
        ...
        style.textContent = `
            ...
            [dir="rtl"] .fade-in-left.scroll-animate {
                transform: translateX(30px);
            }
            [dir="rtl"] .fade-in-right.scroll-animate {
                transform: translateX(-30px);
            }
        `;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '3b80aea9-1d4c-4383-a3e5-efdd0ff9a393',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '3b80aea9-1d4c-4383-a3e5-efdd0ff9a393';
...
/* ZAPPY_CUSTOM_JS_START:8de5b6d06457 */
(function () {
  function __zappyCustomInit() {
    try {
(function () {
  var section = document.querySelector('.home-hero-slider-section');
  if (!section) return;
  var slides = section.querySelectorAll('.hhero-slide');
  ...
  function goTo(index) {
    ...
    if (prev) prev.classList.remove('hhero-slide--active');
    if (next) next.classList.add('hhero-slide--active');
    current = index;
  }
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3b80aea9-1d4c-4383-a3e5-efdd0ff9a393';
